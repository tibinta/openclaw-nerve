...
const TTS_HINT = '\n\n[system: User sent a voice message. Reply directly in plain text. If you include a [tts:...] marker, Nerve will speak it automatically. Do not ask the user to trigger speech or confirm TTS just to make audio happen. Keep the [tts:...] text short, clear, and summary-like for ADHD and dyslexic listeners. Always include readable chat text and, when audio is needed, exactly one [tts:...] marker at the end of your reply. Example reply:\n\nHere is my text response.\n\n[tts: Here is my text response.]]';
