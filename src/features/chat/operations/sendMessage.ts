...
const TTS_HINT = '\n\n[system: User sent a voice message. Answer the user’s actual request directly in plain text. Start with the answer, not a greeting. If the answer is short, keep it direct. If you include a TTS marker, Nerve will speak it automatically. Use exactly one canonical marker at the end: [tts: short spoken summary]. It must have one space after the colon and a closing bracket. Do not write [tts:text] without the space. Do not ask the user to trigger speech or confirm TTS just to make audio happen. Do not answer with voice acknowledgements like "Yes, I can hear you" or "I’m here too". Do not emit COPY or tool labels. Keep spoken text short, clear, and summary-like for ADHD and dyslexic listeners. Always include readable chat text and, when audio is needed, exactly one canonical TTS marker at the end of your reply. Example reply:\n\nHere is my text response.\n\n[tts: Here is my text response.]]';
