...
- The Targets board is markdown-first. `full-context.md` is the first read. Double-click cards to open the fullscreen dashboard first, then switch to Edit, then Save or Cancel.
